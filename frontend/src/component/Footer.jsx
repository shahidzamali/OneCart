        ...
        <div className='w-[100%] md:h-[30vh] h-[15vh]  md:mb-[0px] bg-[#dbfcfcec] flex items-center justify-center md:px-[50px] px-[5px]'>
            ...
            <div className='md:w-[25%] w-[30%] h-[100%] flex items-center justify-center flex-col text-center'>
                ...
                <div className='md:w-[25%] w-[40%]  h-[100%] flex items-center justify-center flex-col text-center '>
                     ...
                     <ul>
                         <li className='text-[15px] text-[#1e2223] '>+91-7903736395</li>
                        <li className='text-[15px] text-[#1e2223] '>zam@onecart.com</li>
                        <li className='text-[15px] text-[#1e2223] hidden md:block'>+91-9296545453</li>
                        <li className='text-[15px] text-[#1e2223] hidden md:block'>zam@onecart.com</li>
                    </ul>
                </div>

        </div>
        <div className='w-[100%] h-[1px] bg-slate-400'></div>
        <div className='w-[100%] h-[5vh] bg-[#dbfcfcec] flex items-center justify-center'>Copyright 2025 zam@onecart.com-All Rights Reserved</div>
